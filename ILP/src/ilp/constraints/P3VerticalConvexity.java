    ...
    public void add(ModelContext ctx) throws GRBException {
        ...
        for (int i = 0; i < nEntities; i++) {
            for (int j = 1; j < ctx.dimensions; j++) {
                ...
                expr.addTerm(1.0, ctx.v.entities[i].rowBounds[j + 1][0]);
                expr.addTerm(-1.0, ctx.v.entities[i].rowBounds[j][0]);
                ...
                expr2.addTerm(1.0, ctx.v.entities[i].rowBounds[j - 1][0]);
                expr2.addTerm(-1.0, ctx.v.entities[i].rowBounds[j][0]);
                ...
                expr3.addTerm(1.0, ctx.v.entities[i].rowBounds[j+1][1]);
                expr3.addTerm(-1.0, ctx.v.entities[i].rowBounds[j][1]);
                ...
                expr4.addTerm(1.0, ctx.v.entities[i].rowBounds[j-1][1]);
                expr4.addTerm(-1.0, ctx.v.entities[i].rowBounds[j][1]);
